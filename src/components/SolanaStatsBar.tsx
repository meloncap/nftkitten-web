...
export const SolanaStatsBar = () => {
  ...
  return (
    <div className='flex flex-row flex-wrap justify-between items-center p-2 text-white bg-slate-900'>
      <div className='flex flex-row items-center'>
        ...
        <div className='mr-2 ml-1 text-xs'>
          {isLoadingSol ? (
            ...
            <>
              SOL<span className='hidden sm:inline'> Price</span> $
              {dataSol?.priceUsdt + ' '}
        ...
        <div className='mr-2 ml-1 text-xs'>
          {isLoadingEth ? (
            ...
            <>
              ETH<span className='hidden sm:inline'> Price</span> $
              {dataEth?.priceUsdt + ' '}
              <span className='hidden md:inline'>
                VOL $
                {new Intl.NumberFormat('en-US', {
      ...
      <span className='inline-flex flex-nowrap space-x-5'>
        <a
          href={`https://github.com/nftkitten`}
          target='_blank'
          rel='noreferrer'
        >
          <svg
        ...
        <a
          href='https://twitter.com/nftkitten_io'
          target='_blank'
